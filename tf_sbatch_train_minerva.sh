...
CONFIGFILE=Configs/tf_mnv_vtxfindr_wilson_cluster_predict_Amc_using_Etargbal.cfg
CONFIGFILE=Configs/tf_mnv_vtxfindr_wilson_cluster_predict_Adata_using_Etargbal.cfg
